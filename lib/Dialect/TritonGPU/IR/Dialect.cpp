...
LogicalResult DialectInferLayoutInterface::inferReduceOpEncoding(
...
LogicalResult DialectInferLayoutInterface::inferExpandDimsOpEncoding(
...
// srcEnc.
static LogicalResult inferReshapeOpLegacyEncoding(ArrayRef<int64_t> srcShape,
                                                  Attribute srcEnc,
...
LogicalResult DialectInferLayoutInterface::inferReshapeOpEncoding(
...
LogicalResult DialectInferLayoutInterface::verifyLayoutsAreEqual(
...
LogicalResult DialectInferLayoutInterface::inferDefaultJoinOpEncoding(
...
LogicalResult DialectInferLayoutInterface::inferSplitOpEncoding(
    Attribute srcEnc, Attribute &dstEnc, ArrayRef<int64_t> shape,
    std::optional<Location> loc) const {
...
LogicalResult DialectInferLayoutInterface::inferFp4ToFpOpEncoding(
...
//===----------------------------------------------------------------------===//
// GPU Infer Layout Interface (Dot Layout sensitive)
//===----------------------------------------------------------------------===//
